            ...
            <div style={card}>
                ...
                {tab === "login" && (
                    <form onSubmit={handleLogin} style={formStyle}>
                        <div>
                            ...
                            <input required type="email" placeholder="provider@rental.com"
                ...
                {tab === "register" && (
                    <form onSubmit={handleRegister} style={formStyle}>
                        <div style={row}>
                            <Field label="Name" value={form.ownerName} onChange={set("ownerName")} placeholder="Ravi Kumar" />
                            <Field label="Company" value={form.companyName} onChange={set("companyName")} placeholder="City Rentals" />
                        </div>
                        <div style={row}>
                            <Field label="Phone" type="tel" value={form.phone} onChange={set("phone")} placeholder="9876543210" />
                            <Field label="Email" type="email" value={form.email} onChange={set("email")} placeholder="you@rental.com" />
                        </div>
                        <Field label="Office Address" value={form.address} onChange={set("address")} placeholder="Pickup point address" />
                        <Field label="Total Fleet" type="number" value={form.totalVehicles} onChange={set("totalVehicles")} placeholder="e.g. 5" style={{ maxWidth: 160 }} />
...
const tabActive = { background: "#1db954", color: "#000", borderColor: "#1db954" };
...
const btnPrimary = { marginTop: 4, padding: "13px 0", background: "linear-gradient(135deg,#1db954,#179c45)", color: "#000", fontWeight: 800, fontSize: 15, border: "none", borderRadius: 12, cursor: "pointer" };
